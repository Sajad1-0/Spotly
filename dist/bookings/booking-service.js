...
class BookingService {
    ...
    async create(createBooking) {
        ...
        const checkRoomAvailability = await bookingService.findBookingByRoomIdAndDate(createBooking.roomId, createBooking.startTime, createBooking.endTime);
        if (checkRoomAvailability.length > 0) {
            loggar_1.logger.error(`Room is already booked at choosen tid
