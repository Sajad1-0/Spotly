...
class bookingRepository {
    ...
    async findBookingByRoomIdAndDate(roomId, startTme, endTime) {
        return await rooms_Repository_1.db.select()
            .from(schema_1.bookingSchema)
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.bookingSchema.roomId, roomId), (0, drizzle_orm_1.or)((0, drizzle_orm_1.and)((0, drizzle_orm_1.lte)(schema_1.bookingSchema.startTime, endTime), (0, drizzle_orm_1.gte)(schema_1.bookingSchema.endTime, startTme)), (0, drizzle_orm_1.and)((0, drizzle_orm_1.lte)(schema_1.bookingSchema.startTime, startTme), (0, drizzle_orm_1.gte)(schema_1.bookingSchema.endTime, endTime)))));
    }
    async delete(id) {
        if (!id) {
